...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <form action="{{ route('pages.update', $dat->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PATCH')
            <div class="card">
                <div class="card">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control" placeholder="Edit Page Title Here..." name="title" id="title" value="{{ $dat->title }}">
                                    </div>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <textarea name="body" id="post-body">{{ $dat->body }}</textarea>
                </div>
            </div>
            ...
            <div class="card">
                <div class="footer">
                    <div class="container-fluid">
                        ...
                        <button type="submit" class="pull-right btn btn-success waves-effect">Update >></button>
                    </div>
                    <br>
                </div>
            </div>
